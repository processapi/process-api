...
export class OllamaSettings extends HTMLElement {
    ...
    async connectedCallback() {
        ...
        this.shadowRoot.querySelector("#btnClose").addEventListener("click", this.#btnCloseClickHandler);
    }

    async disconnectedCallback() {
        this.shadowRoot.querySelector("#btnClose").removeEventListener("click", this.#btnCloseClickHandler);
